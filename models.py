...
from torchvision.models import resnet152, vgg19, resnet50, resnet101
import random
...
class Encoder(nn.Module):
    ...
    Arguments:
        network (str): Network to be used as the encoder. Options = 'vgg19', 'resnet152', 'resnet50' or 'resnet101'. Default = 'vgg19'
    '''
